...
public class TesteRegrasCadastro {
	...
	@Parameters
	public static Collection<Object[]> getColeCollection(){
		return Arrays.asList(new Object[][] {
			{"", "", "", Arrays.asList(), new String[]{}, "Nome eh obrigatorio"},
			{"Lucas", "", "", Arrays.asList(), new String[]{}, "Sobrenome eh obrigatorio"},
			{"Lucas", "Silva", "", Arrays.asList(), new String[]{}, "Sexo eh obrigatorio"},
			{"Lucas", "Silva", "Masculino", Arrays.asList("Carne", "Vegetariano"), new String[]{}, "Tem certeza que voce eh vegetariano?"},
			{"Lucas", "Silva", "Masculino", Arrays.asList("Carne"), new String[]{"Karate", "O que eh esporte?"}, "Voce faz esporte ou nao?"}
		});
	}
